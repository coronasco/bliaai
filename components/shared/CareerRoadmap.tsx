...
const CareerRoadmap = ({
  ...
  const handleCreateRoadmap = async (
    ...
    try {
      ...
      toast.error('A apărut o eroare la generarea roadmap-ului');
    } finally {
  ...
  // Add a function to generate a tutorial for a section
  // Funcția neutilizată a fost eliminată
  // const handleGenerateSectionTutorial = async () => {...};
        ...
        <Card className="shadow-lg overflow-hidden border border-gray-700 bg-gray-900">
          ...
          <CardContent className="py-12 px-6 bg-gray-900">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-3">No Career Roadmap Generated Yet</h3>
              <p className="text-gray-400 mb-6 max-w-md mx-auto">Generate a personalized career roadmap to visualize and track your professional learning journey.</p>
              ...
              >
                {isRoadmapGenerating ? (
                  ...
                  <>
                    <FaBrain className="mr-2" />
                    {getRoadmapLevel() === "none" ? "Generate Roadmap - Beginner" : `Generate Roadmap - ${getRoadmapLevel() === "beginner" && isPremium ? "Intermediate" : getRoadmapLevel() === "intermediate" && isPremium ? "Advanced" : getRoadmapLevel() === "advanced" ? "Complete" : "Beginner"}`}
                  </>
                )}
              </Button>
            </div>
